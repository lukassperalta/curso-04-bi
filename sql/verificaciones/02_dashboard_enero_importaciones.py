...
# SCRIPT:   Verificación IMPORTACIÓN desde CSV Crudo (Año Completo)
...
# CARGA DE DATOS
# ==========================================================
header(f"Verificación IMPORTACIÓN desde CSV Crudo ({len(ARCHIVOS_CSV)} archivos)")
