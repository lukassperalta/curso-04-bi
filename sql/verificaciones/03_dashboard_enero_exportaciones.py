...
# SCRIPT:   Verificación EXPORTACIÓN desde CSV Crudo (Año Completo)
...
# CARGA DE DATOS
# ==========================================================
header(f"Verificación EXPORTACIÓN desde CSV Crudo ({len(ARCHIVOS_CSV)} archivos)")
